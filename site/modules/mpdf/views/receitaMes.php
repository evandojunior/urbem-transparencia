...
<thead>
	<tr id="principal">
		...
		<td width="150px" align="right">Realizado (<?php echo utf8_encode(getMeses($mes)) ?>)</td>
...
?>
	<tr style="<?php echo $strong;?>" id="principal">
		<td width="560px" style="padding-left: <?php echo $padding;?>px"><?php echo $receita['cod_conta']." - ".utf8_encode($receita['especificacao_conta']);?></td>
