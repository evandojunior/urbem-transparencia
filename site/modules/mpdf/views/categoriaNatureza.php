...
?>
	<tr>
		...
		<td align="center" class="empenho"><a href="<?php echo url('despesa/categoria/natureza/elemento_despesa/'.$despesa['categoria_economica']); ?>" class="empenho" title="Detalhes">&nbsp;</a></td>
	</tr>
<?php
    } 
